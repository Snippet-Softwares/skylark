// Section with Editor
  ...
  $.fn.sectionJs = function(){
    var $this = this;
    if($this.data('section') == "headerscript") {
      $this.headerscript();
    }else if($this.data('section') == "sliderone") {
    	$this.find('.home1-slider').sliderone();
  	}else{}   
  }
  ...
  $.fn.headerscript = function() {
    /* Mega Menu */
    $('.mega_dropdown').parent('ul').addClass('mega-menu d-block');
    $('.drop_item').parent('ul').addClass('sub-menu');
    $('.multi_item').parent('ul').addClass('sub-menu');
  };

	// Home 1 Slider
	$.fn.sliderone = function() {
...
(function($) {
  ...
  jQuery(document).ready(function(){
    ...
    $('#ageree_term_cond').on('click', function(){
      $(this).parent('.cart-box-product').toggleClass('disabled');
    });
    
    /*---------------------
        Cart Page
    --------------------- */
    $('#cart_button_agree').on('click', function(){
      $(this).parent('.proceed-to-checkout').toggleClass('disabled');
    });
